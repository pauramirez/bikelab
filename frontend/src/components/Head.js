            ...
            <div className="row">
              <div className="col-lg-4">
                ...
                <div className="box clearfix">
                  <Link to={{
                    pathname: `/accessories/${this.state.accessory1._id}`,
                    state: {accessory: this.state.accessory1}
                  }}>
              ...
              <div className="col-lg-4">
                ...
                <div className="box clearfix">
                  <Link to={{
                    pathname: `/accessories/${this.state.accessory2._id}`,
                    state: {accessory: this.state.accessory2}
                  }}>
              ...
              <div className="col-lg-4">
                ...
                <div className="box clearfix">
                  <Link to={{
                    pathname: `/accessories/${this.state.accessory3.id}`,
                    state: {accessory: this.state.accessory3}
                  }}>
